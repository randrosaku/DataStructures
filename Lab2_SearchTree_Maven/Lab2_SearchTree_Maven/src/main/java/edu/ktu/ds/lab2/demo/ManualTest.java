...
public class ManualTest {
    ...
    public static void executeTest() throws CloneNotSupportedException {
        ...
        Car c10 = new Car("Renault Laguna 2002 115900 700");
        ...
        Car[] carsArray = {c7, c8, c2, c9, c6};
        Ks.oun("Car set 1:");
        ParsableBstSet<Car> carsSetBst = new ParsableBstSet<>(Car::new);
        for (Car c : carsArray) {
            carsSetBst.add(c);
        }
        Ks.ounn(carsSetBst.toVisualizedString(""));
        ...
        Car[] carsArray2 = {c8, c2};
        ParsableBstSet<Car> carsSetBst2 = new ParsableBstSet<>(Car::new);
        for (Car c : carsArray2) {
            carsSetBst2.add(c);
        }
        Ks.ounn(carsSetBst2.toVisualizedString(""));

        Ks.oun("");
        Ks.oun("RemoveAll returns true if all items from Car set 2 were removed from Car set 1.");
        boolean removeAll = carsSetBst.removeAll(carsSetBst2);
        System.out.println(removeAll);

        Ks.oun("Remaining set:");
        Ks.ounn(carsSetBst.toVisualizedString(""));
